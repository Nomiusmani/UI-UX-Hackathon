  ...
  const posts = [
    {
      ...
      img: "/images/unsplash_hHdHCfAifHU.png", // Updated image path
      date: "22 April 2021",
      comments: 10,
      tag: "NEW",
    },
    {
      ...
      title: "Loudest à la Madison #1 (L'Integrál)",
      description: "We focus on ergonomics and meeting you where you work. It's only a keystroke away.",
      img: "/images/unsplash_tVEqStC2uz8.png", // Updated image path
      date: "22 April 2021",
      comments: 10,
      tag: "NEW",
    },
    {
      ...
      title: "Loudest à la Madison #1 (L'Integrál)",
      description: "We focus on ergonomics and meeting you where you work. It's only a keystroke away.",
      img: "/images/unsplash_dEGu-oCuB1Y.png", // Updated image path
      date: "22 April 2021",
      comments: 10,
      tag: "NEW",
    },
  ...
  return (
    <div className="bg-white py-10 mt-28">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-500 font-medium text justify-center">
